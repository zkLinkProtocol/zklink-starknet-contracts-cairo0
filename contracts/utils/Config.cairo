...
# Operation chunks
const DEPOSIT_BYTES = 4 * CHUNK_BYTES
const FULL_EXIT_BYTES = 4 * CHUNK_BYTES
const WITHDRAW_BYTES = 4 * CHUNK_BYTES
const FORCED_EXIT_BYTES = 3 * CHUNK_BYTES
const CHANGE_PUBKEY_BYTES = 4 * CHUNK_BYTES
